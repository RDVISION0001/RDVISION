...
function indexm() {
    ...
    const stompClient = new Client({
      ...
      onConnect: () => {
        ...
        stompClient.subscribe('/topic/third_party_api/ticket/', (message) => {
          ...
          playNotificationSound()
          // localStorage.getItem("numberOfNewTickets") ? localStorage.setItem("numberOfNewTickets", JSON.stringify(localStorage.getItem("numberOfNewTickets").push(newProduct.uniqueQueryId))) : localStorage.setItem("numberOfNewTickets", JSON.stringify([newProduct.uniqueQueryId]))
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      handleClose();
      // if (localStorage.getItem("numberOfNewTickets")) {
      //   if (JSON.parse(localStorage.getItem("numberOfNewTickets")).includes(uniqueQueryId)) {
      //     localStorage.setItem("numberOfNewTickets", JSON.parse(localStorage.getItem("numberOfNewTickets")).filter(item => item != uniqueQueryId))
      //   }
      // }
      fetchData()
      setError(null);
                  ...
                  >
                    ...
                    <li className="nav-item" role="presentation">
                      ...
                      >
                        ...
                        New Tickets
                        {/* <span class="badge badge-primary bg-danger text-white font-semibold rounded-circle m-1">{localStorage.getItem("numberOfNewTickets") ? JSON.parse(localStorage.getItem("numberOfNewTickets")).length : null}</span> */}
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
