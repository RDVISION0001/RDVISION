  ...
  return (
    <>
     <div className="superadmin-page">
      ...
      {/* <!-- Main Wrapper --> */}
      <div
        className="my-container main-content-block2658 orders-status-page active-cont"
      >
        {/* <!-- Top Nav --> */}
        <Topnav />
        {/* <!--End Top Nav --> */}
        <div className="container-fluid mt-3">
          ...
          {/* <!-- graphs and ranking --> */}
          <section className="orders-view-wrapper py-5">
            <div className="container-fluid">
              <div className="row">
                <div className="col-5">
                  <div className="order-menu-wrapper">
                    <div
                      className="nav flex-column vertical-tab-nav"
                      id="v-pills-tab"
                      role="tablist"
                    ...
                    >
                      <button
                        ...
                        id="v-pills-ticket1-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-ticket1"
                        type="button"
                        role="tab"
                        aria-controls="v-pills-ticket1"
                        aria-selected="true"
                      >
                        <div className="order-card">
                          ...
                          <div className="right-part">
                            AT : <span className="badge">Preparing</span>
                          </div>
                        </div>
                      </button>
                      ...
                      <button
                        className="nav-link"
                        id="v-pills-ticket2-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-ticket2"
                        type="button"
                        role="tab"
                        aria-controls="v-pills-ticket2"
                        aria-selected="true"
                      >
                        <div className="order-card">
                          <div className="left-part">
                          ...
                          <div className="right-part">
                            AT : <span className="badge">Custom</span>
                          </div>
                        </div>
                      </button>
                      ...
                      <button
                        className="nav-link"
                        id="v-pills-ticket3-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#v-pills-ticket3"
                        type="button"
                        role="tab"
                        aria-controls="v-pills-ticket3"
                        aria-selected="true"
                      >
                        <div className="order-card">
                          <div className="left-part">
                  ...
                  >
                    ...
                    >
                      <div className="order-cards-details-wrapper-main">
                            ...
                            <div className="content-wrapper">
                              ...
                              <div className="contact-wrapper">
                                <div className="contact-item">
                                  <i className="fa-solid fa-phone"></i> +91 0000 000
                                  000
                                </div>
                                <div className="contact-item">
                              ...
                              <div className="address-items mt-2">
                                ...
                                <address>
                                  098, Viraj khand, Gomti Nagar, Lucknow UP
                                  India 206202
                                </address>
                              </div>
                        ...
                        <div
                          className="accordion status-wrappers"
                          id="accordionExample"
                        >
                          ...
                          <div className="accordion-item payment">
                            ...
                            >
                              <div className="accordion-body">
                                ...
                                plugin adds the appropriate classNamees that we use
                                to style each element. These classNamees control the
                                ...
                                <div className="status-list-view-wrapper">
                                  <ul className="status-list">
                                    ...
                                    <li className="status-item pending">
                                      ...
                                      <small
                                        >02 Mar 2024 From Origin, India</small
                                      >
                                    </li>
                                    <li className="status-item blocked">
                                      <h3 className="title">
                                        On the Way Via Sea Way
                                      </h3>
                                      <small
                                        >02 Mar 2024 From Origin, India</small
                                      >
                                  ...
                                  <div className="form-group px-3 offset-1 col-7">
                                    ...
                                    <div className="col-12 d-flex gap-2 mt-2">
                                      <input
                                        ...
                                        id="reference-ticket-gen"
                                      />
                                      <label
                                        for="reference-ticket-gen"
                                        className="form-label"
                                        >Generate Reference Token For Future
                                        Order</label
                                      >
                                    </div>
                                  </div>
                    ...
                    <div
                      ...
                      id="v-pills-ticket2"
                      role="tabpanel"
                      aria-labelledby="v-pills-ticket2-tab"
                      tabindex="0"
                    >
                      <div className="order-cards-details-wrapper-main">
                        <div className="order-details-card">
                    ...
                    <div
                      ...
                      id="v-pills-ticket3"
                      role="tabpanel"
                      aria-labelledby="v-pills-ticket3-tab"
                      tabindex="0"
                    >
                      <div className="order-cards-details-wrapper-main">
                        <div className="order-details-card">
