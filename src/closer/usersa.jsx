  ...
  return (
    <>
      <div className="superadmin-page">
        ...
        {/* <!-- Main Wrapper --> */}
        <div
          className="my-container main-content-block2658 user-management-page active-cont">
          {/* <!-- Top Nav --> */}
          <Topnav />
          {/* <!--End Top Nav --> */}
          <div className="container-fluid mt-3">
                    ...
                    <div className="user-team-card">
                      ...
                      <div className="content-area">
                        ...
                        <p className="sub-title">
                          Department : <strong>Admin's Head</strong>
                        </p>
                        <span className="other-info"
                        >IP Series : <mark>10.132.30.41</mark></span
                        >
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6">
                    <div className="user-team-card">
                      ...
                      <div className="content-area">
                        <h3 className="title">Dig Vijay</h3>
                        <p className="sub-title">
                          Department : <strong>Sale's Head</strong>
                        </p>
                        <span className="other-info"
                        >IP Series : <mark>10.132.30.41</mark></span
                        >
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="user-team-card">
                      ...
                      <div className="content-area">
                        <h3 className="title">Dig Vijay</h3>
                        <p className="sub-title">
                          Department : <strong>HR's Head</strong>
                        </p>
                        <span className="other-info"
                        >IP Series : <mark>10.132.30.41</mark></span
                        >
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="user-team-card">
                      ...
                      <div className="content-area">
                        <h3 className="title">Dig Vijay</h3>
                        <p className="sub-title">
                          Department : <strong>Marketing's Head</strong>
                        </p>
                        <span className="other-info"
                        >IP Series : <mark>10.132.30.41</mark></span
                        >
            ...
            {/* <!-- section 2 --> */}
            <section className="data-table-bgs_02x24 user-table-section py-3">
              <div className="container-fluid">
                <div className="table-wrapper">
                  <h3 className="title">Users Table</h3>
                  <nav className="recent-transactions-tab-header">
                    <div
                      className="nav nav-item nav-tabs"
                      id="nav-tab"
                      role="tablist"
                    >
                      <button
                      ...
                      <button
                        ...
                        data-bs-toggle="tab"
                        data-bs-target="#nav-new-users"
                        type="button"
                        role="tab"
                        aria-controls="nav-new-users"
                        aria-selected="false"
                      >
                        New Users
                      </button>
                      <button
                        className="nav-link"
                        id="nav-restricted-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#nav-restricted"
                        type="button"
                        role="tab"
                        aria-controls="nav-restricted"
                        aria-selected="false"
                      >
                        Restricted Users
                      </button>
                  ...
                  >
                    <div
                      className="tab-pane table-responsive all-users-tab fade show active"
                      id="nav-all-users"
                      role="tabpanel"
                    ...
                    {/* <!-- new users tab --> */}
                    <div
                      className="tab-pane new-users-tab fade table-responsive"
                      id="nav-new-users"
                      role="tabpanel"
                    ...
                    <div
                      className="tab-pane restricted-tab fade table-responsive"
                      id="nav-restricted"
                      role="tabpanel"
                      aria-labelledby="nav-restricted-tab"
                      tabindex="0"
                    >
                      <table className="table users-table">
                        <thead>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Sales</td>
                            <td>
                              <span className="status bg-danger text-white"
                              >Blocked</span
                              >
                            </td>
      ...
      {/* <!-- Add User Modal --> */}
      <div
        className="modal user-mmt-modal add-new-user fade"
        id="addUser"
        tabindex="-1"
                  ...
                  <div className="row p-0">
                    <div className="col-3">
                      <div className="user-profile">
                        <img
                          src="../img/profiles/profile08.png"
                          className="img-fluid"
                          alt="upload-profile"
                        />
                        <div className="upload-profile-wrapper">
                          <input
                            ...
                            hidden
                          />
                          <label for="upload-profile-img" className="form-label"
      ...
      <div
        className="modal user-mmt-modal fade"
        id="exampleModal"
        tabindex="-1"
