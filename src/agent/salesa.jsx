  ...
  return (
    <>
      <div className="superadmin-page">
        ...
        {/* <!-- Main Wrapper --> */}
        <div
          className="my-container main-content-block2658 sales-status-page active-cont">
          {/* <!-- Top Nav --> */}
          <Topnav />
          {/* <!--End Top Nav --> */}
                  ...
                  >
                    ...
                    >
                      <table className="table">
                        ...
                        {orders.map(orders => (
                          <tbody key={orders.ticketId}>
                            <h6>{orders.ticketId}</h6>
                            {orders.productOrders.map(po => (
                              <tr key={po.productorderId}>
                                <td className="selection-cell">
                                  <input type="checkbox" className="" />
                                </td>
                                <td>{po.product[0].name}</td>
                                <td>{po.product[0].brand}</td>
                                <td>{po.product[0].composition}</td>
