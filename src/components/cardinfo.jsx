...
const Cardinfo = () => {
  ...
  return (
    <section
      className={`sadmin-top-section  w-100 ${dark ? "bg-dark" : ""} `}
    >
        ...
        <div className="row py-2">
          <div className="col-md-3">
            ...
            >
              ...
              <div
                className={`details-box position-absolute border rounded p-3 shadow transition-all duration-300 
              ...
              >
                <p>Total Follow-ups: {data.totalFollow}</p>
                <p>Total New: {data.totalNew}</p>
          ...
          <div className="col-md-3">
          <div className={`card  ${dark ? "bg-secondary text-light" : "" }`} >
              <div className="div-top">
          ...
          <div className="col-md-3 d-flex justify-content-between align-items-center">
            <div className={`card d-flex justify-content-between w-100 ${dark?"bg-secondary text-light":""} `}>
              <div className="div-top">
