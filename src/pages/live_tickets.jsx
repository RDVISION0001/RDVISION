                                ...
                                <tr key={index}>
                                  ...
                                  <td>
                                    <span className="actions-wrapper">
                                      ...
                                      <a
                                        href={`sms:${item.senderMobile}?&body=${`Hey ${item.senderName} I just received an inquiry from you that is ${item.subject}. If you are interested please reply YES`}`}
                                      ...
                                      ></Button>
                                      <a href={`https://wa.me/${item.senderMobile.split("-")[1]}?text=${`Hey ${item.senderName} I just received an inquiry from you that is ${item.subject}. If you are interested please reply YES`}`}
                                        target='_blank'
