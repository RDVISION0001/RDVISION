                          ...
                          {data ? (
                            <tbody>
                              {data
                                ...
                                .filter((item) => countryFilter.length === 0 || countryFilter.includes(item.senderCountryIso))
                                .filter((item) => item.senderCountryIso !== "IN")
                                .slice(itemsPerPage * currentPage, itemsPerPage * (currentPage + 1)) // Paginate the data
                                .map((item, index) => (
                                  <tr key={index}
